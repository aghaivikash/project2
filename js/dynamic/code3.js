    ...
    if (BABYLON.Engine.isSupported()) {
      ...
      scene.collisionsEnabled = true;
        ...
        var plane5 = BABYLON.MeshBuilder.CreateBox("plane1", {height: 30, width:30, depth:30}, scene);
            plane5.position = new BABYLON.Vector3(900.2041,105,2868.254);
            ...
            plane5.actionManager = new BABYLON.ActionManager(scene);
           plane5.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
...
function HandlePopup(objName) {
	...
	} else if(PopupSwitch != ''&&PopupSwitch == 'Off') {
		document.getElementById("popup").style.display="block";
  //document.getElementById("babylonjsLoadingDiv").style.display="block";
