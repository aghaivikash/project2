...
function startFunction() {
    if (BABYLON.Engine.isSupported()) {
     ...
     //engine = new BABYLON.Engine(canvas, true, { limitDeviceRatio: 2 }, true);
...
//var gamepads = new BABYLON.Gamepads(function (gamepad) { onNewGamepadConnected(gamepad); });
     //var gamepads = new BABYLON.Gamepads(function (gamepad) { onNewGamepadConnected(gamepad); });
    	...
    	//Camera
      //camera = new BABYLON.VirtualJoysticksCamera("VJC", new BABYLON.Vector3(-1800,230,3200), scene);
    	camera = new BABYLON.FreeCamera("camera1", new BABYLON.Vector3(-1000,230,3200),scene);//(-1800,230,3200)
    ...
    //var camera2 = new BABYLON.FreeCamera("camera2", new BABYLON.Vector3(-500, 230, 3300), scene);

        //......................MY CODE ON 20 MARCH 2017..................
      //  var plane5 = BABYLON.MeshBuilder.CreateBox("plane1", {height: 130, width:130, depth:10}, scene);
            //plane5.position = new BABYLON.Vector3(860.2041,135,2568.254);
            //plane5.position = new BABYLON.Vector3(-672.2041,230,3586.254);
         ...
         // videoMat.emissiveTexture = new BABYLON.VideoTexture("video", ["assets/Jolly LLB.mp4"], scene, false);
           videoMat1.emissiveTexture = new BABYLON.VideoTexture("video", ["assets/party.mp4"], scene, false);
           //videoMat.emissiveTexture = new BABYLON.VideoTexture("video", ["Party On My Mind.mp4"], scene, false);
          videoMat1.backFaceCulling = false;
          plane6.material=videoMat1;
          var music1 = new BABYLON.Sound("music", "assets/party1.mp3",
        ...
        music1.attachToMesh(plane6);
         ...
         maxDistance:800
          ...
          //videoMat.emissiveTexture = new BABYLON.VideoTexture("video", ["assets/Jolly LLB.mp4"], scene, false);
           videoMat.emissiveTexture = new BABYLON.VideoTexture("video", ["assets/Gounder1.mp4"], scene, false);
           //videoMat.emissiveTexture = new BABYLON.VideoTexture("video", ["Party On My Mind.mp4"], scene, false);
        ...
        var music2 = new BABYLON.Sound("music", "assets/party1.mp3",
        scene, null, { loop: true, autoplay: true, spatialSound: true });
        //music2.attachToMesh(tv2);
        music2.setPosition(new BABYLON.Vector3(-445, 230, 3793));
          music2.updateOptions({
         maxDistance:400
    ...
    var music = new BABYLON.Sound("music", "assets/gounders.mp3",
    scene, null, { loop: true, autoplay: true, spatialSound: true });
    music.attachToMesh(plane71);
    music.updateOptions({
      maxDistance:1200

    });
    //music.setPosition(new BABYLON.Vector3(900, 262, 3523));
         //.........................................................................   
       ...
       /* var light2 = new BABYLON.HemisphericLight("Hemi0", new BABYLON.Vector3(-2000,250,3300), scene);
        ...
        // .... my code 13/06/2017.........................
        // .....2d image start ....................
       /* var spriteManagerPlayer = new BABYLON.SpriteManager("playerManagr","assets/palm.png", 1, 800, scene);
        var player = new BABYLON.Sprite("player", spriteManagerPlayer);
        player.position= new BABYLON.Vector3(-640,230,3466); */
        //player.size = 0.9;
       // player.isPickable = true;
        ...
        //player.height = 0.9;
        //ON MOUSE ENTER
      //player.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
       // }));
       //................2d image end...................
       //.......360 rotation......................
       var plane360 = BABYLON.MeshBuilder.CreateBox("plane360", {height: 30, width:30, depth:02}, scene);
            //plane5.position = new BABYLON.Vector3(860.2041,135,2568.254);
            plane360.position = new BABYLON.Vector3(-167.2041,200,2946.254);
            plane360.rotation.x = Math.PI/6;
          ...
          var material360 = new BABYLON.StandardMaterial("material1", scene);
            ...
            var plane361 = plane360.clone("plane361");
            plane361.position.x += 50;
            //plane361.billboardMode = BABYLON.Mesh.BILLBOARDMODE_ALL;
            plane361.actionManager = new BABYLON.ActionManager(scene);
            plane361.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));
          

             var plane362 = plane361.clone("plane362");
            plane362.position.x += 50;
            plane362.actionManager = new BABYLON.ActionManager(scene);
            plane362.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane363 = plane362.clone("plane363");
            plane363.position.x += 50;
            plane363.actionManager = new BABYLON.ActionManager(scene);
            plane363.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane364 = plane363.clone("plane364");
            plane364.position.x += 50;
            plane364.actionManager = new BABYLON.ActionManager(scene);
            plane364.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane365 = plane364.clone("plane365");
            plane365.position.x += 50;
            plane365.actionManager = new BABYLON.ActionManager(scene);
            plane365.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane366 = plane365.clone("plane366");
            plane366.position.x += 50;
            plane366.actionManager = new BABYLON.ActionManager(scene);
            plane366.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane367 = plane366.clone("plane367");
            plane367.position.x += 50;
            plane367.actionManager = new BABYLON.ActionManager(scene);
            plane367.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));

             var plane368 = plane367.clone("plane368");
            plane368.position.x += 50;
            plane368.actionManager = new BABYLON.ActionManager(scene);
            plane368.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPointerOverTrigger, function(ev){ 
             }));
  ...
  /*  glass.reflectionTexture = hdrTexture;    
    ...
    //glass.receiveShadows = true;
        ...
        window.addEventListener("click", function () {
            ...
            if (pickResult.hit) {
                ...
                if ((pickResult.pickedMesh.name == "mac1" || pickResult.pickedMesh.name == "mac2" || pickResult.pickedMesh.name == "mac3"
                    || pickResult.pickedMesh.name == "Object026" || pickResult.pickedMesh.name == "shoe5"|| pickResult.pickedMesh.name == "plane361"
                    ...
                    || pickResult.pickedMesh.name == "Sandal_7" || pickResult.pickedMesh.name == "Sandal_8"|| pickResult.pickedMesh.name == "plane360"
        ...
        // scene.activeCamera = camera2;
           //camera.position = new BABYLON.Vector3(894,850,3600);
           //camera.setPosition(new BABYLON.Vector3(-500,230,3300));
            //alert("hello");
            /*if(divStatus == false) {
        ...
        document.getElementById("right").onclick = function () {
           /* if(divStatus == false) {
            ...
            animateCameraPosition(camera, camera.position,  new BABYLON.Vector3(67,230,3660))
            animateCameraPosition.rotation.y= Math.PI/2;
        };
        ...
        document.getElementById("back").onclick = function () {
            ...
            animateCameraPosition(camera, camera.position,  new BABYLON.Vector3(500,250,3600))
        };
    	...
    	scene.executeWhenReady(function () {
            ...
            engine.runRenderLoop(function () {
                ...
                if (camera.position.x > 496 && camera.position.x < 1000) {
                    if (camera.position.z > 2453 && camera.position.z < 2754) {
                      //animateCameraPosition(camera, camera.position,  new BABYLON.Vector3(894,850,3600));
...
function HandlePopup(objName) {
	...
	if(is_popup_open == true) {
     ...
     //i=1;
        ...
        //.......................14/06/2017.........
        else if (product_name == "plane360" ||product_name == "plane360") {
        //document.getElementById("testing").innerHTML = "<img src='assets/Archmodel.jpg'>";
         /*
         document.write("http://www.mywebsite.com/1.html");*/
           ...
           // alert("hi it is htc mobile");
           

// Init
//window.addEventListener('load', init, false);
//location.assign("aghai/360.html");
