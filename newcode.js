...
function startFunction() {
    if (BABYLON.Engine.isSupported()) {
    	...
    	//Camera
    	camera = new BABYLON.FreeCamera("camera1", new BABYLON.Vector3(-1500,230,3300),scene);
        ...
        /*//Light
        light = new BABYLON.SpotLight("Spot0", new BABYLON.Vector3(-38.982,178.1909,3212.48975), new BABYLON.Vector3(0, -1, -20), 1.5708, 10, scene);
        light.intensity = 0.3;
        ...
        */
    	...
    	var front = BABYLON.MeshBuilder.CreateBox("box",{height:500 ,width: 3250,depth:10},scene);
    	front.position = new BABYLON.Vector3(-2050,225,3250);
    	front.rotation.y=Math.PI/2;
    	front.checkCollisions = true;
    	front.isVisible = false;
        front.freezeWorldMatrix();

    	var rightWall = BABYLON.MeshBuilder.CreateBox("box1",{height:800 ,width: 3300,depth:10},scene);
    	rightWall.position = new BABYLON.Vector3(-390,230,1690);
    	rightWall.checkCollisions = true;
    	rightWall.isVisible = false;
        rightWall.freezeWorldMatrix();
    
    	var leftWall = BABYLON.MeshBuilder.CreateBox("box2",{height:800 ,width: 3300,depth:10},scene);
    	...
    	BABYLON.SceneLoader.ImportMesh("","assets/", "front_glass.babylon", scene, function(newMeshes){
            ...
            var material = new BABYLON.StandardMaterial("material", scene);
            material.emissiveColor = new BABYLON.Color3(0.0,0.2,0.4);
        ...
        BABYLON.SceneLoader.ImportMesh("","assets/", "poster1.babylon", scene, function(newMeshes){
            ...
            var material = new BABYLON.StandardMaterial("material", scene);
            material.emissiveTexture = new BABYLON.Texture("assets/poster1.jpg", scene);
            material.checkReadyOnlyOnce = true;
            material.freeze();
            mesh.material = material;
            mesh.checkCollisions = true; 
        ...
        BABYLON.SceneLoader.ImportMesh("","assets/", "poster2.babylon", scene, function(newMeshes){
            ...
            var material = new BABYLON.StandardMaterial("material", scene);
            material.emissiveTexture = new BABYLON.Texture("assets/poster2.jpg", scene);
            material.checkReadyOnlyOnce = true;
            material.freeze();
            mesh.material = material;
            mesh.checkCollisions = true;
        ...
        BABYLON.SceneLoader.ImportMesh("","assets/", "poster3.babylon", scene, function(newMeshes){
            ...
            var material = new BABYLON.StandardMaterial("material", scene);
            material.emissiveTexture = new BABYLON.Texture("assets/poster3.jpg", scene);
            material.checkReadyOnlyOnce = true;
            material.freeze();
            mesh.material = material;
            mesh.checkCollisions = true;
...
function download2ndfloor() {
	...
	BABYLON.SceneLoader.ImportMesh("","assets/", "paintings.babylon", scene, function(newMeshes){
		var mesh = newMeshes[0];
		var mat = new BABYLON.StandardMaterial("mat", scene);
		mat.emissiveTexture = new BABYLON.Texture("assets/paintings.jpg", scene);
		mat.checkReadyOnlyOnce = true;
        mat.freeze();
		mesh.material = mat;
		mesh.checkCollisions = true;
		...
		if (BABYLON.Engine.isSupported()) {
			var createScene = function () {
			    ...
			    if (product_name == "mac1" || product_name == "mac2" || product_name == "mac3") {
			    	...
			    	popup_camera = new BABYLON.FreeCamera("Camera03", new BABYLON.Vector3(-31.35,192.53,2918.87), scene);
			    	//camera.attachControl(canvas2,false);
			    	...
			    	popup_camera = new BABYLON.FreeCamera("Camera08", new BABYLON.Vector3(-837.38,117.83,2480.60), scene);
